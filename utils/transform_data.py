...
def transform_data(data_inputs_paths):
    ...
    # import y
    df_presidential_2020 = pd.read_csv(path_input_y, converters={"county_fips": str})
    ...
    df_presidential_2020.to_csv(path_save_y, sep=";")
    ...
    df_population_county = standard_x(df_population, county_fips_list)
